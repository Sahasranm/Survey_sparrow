...
const CalendarApp = () => {
  ...
  const renderCells = () => {
    ...
    if (view === "day") {
      ...
      days.push(
        <div key={formattedDate} className="p-4 border rounded bg-white shadow-md">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-200 via-pink-200 to-yellow-100 p-6 transition-all duration-500">
      <div className="flex justify-between mb-6">
        ...
        <div className="text-lg font-bold text-center">{renderHeaderTitle()}</div>
        <button
        ...
        {["month", "week", "day"].map((v) => (
          <button
            ...
            className={`px-4 py-2 rounded shadow-md ${
              view === v ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-800"
